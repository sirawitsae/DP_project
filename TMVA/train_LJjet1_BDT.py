...
def create_bdt(sigTree, bgdTree, out_file):
    ...
    sigCut = TCut("nLJjets20>0&&LJjet1_pt>20e3&&LJjet1_gapRatio>0.9&&LJjet1_EMfrac<0.4")
    bgdCut = TCut("nLJjets20>0&&LJjet1_pt>20e3&&LJjet1_gapRatio>0.9&&LJjet1_EMfrac<0.4")
    #sigCut = TCut("1")
    #bgdCut = TCut("1")
...
# MAIN METHOD =======================================================================================================
def main():
    sigFilepath = "/Users/sirawitsae/Desktop/project/DarkPhoton/vbfljetskim/frvz_vbf_500757.root" ############## change here ##########################
    bgdFilepath = "/Users/sirawitsae/Desktop/project/DarkPhoton/vbfljetskim/wjets_strong_sh227.root"

    sigTree, bgdTree, sigFile, bgdFile = get_trees(sigFilepath, bgdFilepath, "miniT")
	
    create_bdt(sigTree, bgdTree, "lj_bdt.root") ############## change here ##########################
